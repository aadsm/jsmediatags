...
jest.dontMock('../MediaTagReader.js');
...
describe("MediaTagReader", function () {
  ...
  beforeEach(function () {
    ...
    mediaFileReader.init = jest.fn().mockImplementation(function (callbacks) {
      setTimeout(function () {
        callbacks.onSuccess();
      }, 1);
    });
  ...
  it("can read the data given by _parseData", function () {
    var expectedTags = {};
    mediaTagReader._loadData = jest.fn().mockImplementation(function (_, callbacks) {
      setTimeout(function () {
        callbacks.onSuccess();
      }, 1);
    });
    mediaTagReader._parseData = jest.fn().mockImplementation(function () {
      return expectedTags;
    });
  ...
  it("should _loadData when it needs to be read", function () {
    mediaTagReader._loadData = jest.fn().mockImplementation(function (localMediaFileReader, callbacks) {
