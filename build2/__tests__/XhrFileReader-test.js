...
jest.mock('xhr2').dontMock('../XhrFileReader.js').dontMock('../MediaFileReader.js').dontMock('../ChunkedFileData.js');
...
describe("XhrFileReader", function () {
  ...
  var describeFileSizeTests = function describeFileSizeTests(avoidHeadRequests) {
  ...
  describeFileSizeTests(true
  /*GET*/
  );
  describeFileSizeTests(false
  /*HEAD*/
  );
