...
var MP4TagReader = /*#__PURE__*/function (_MediaTagReader) {
  ...
  _createClass(MP4TagReader, [{
    ...
    value: function _parseData(data, tagsToRead) {
      ...
      this._readAtom(tags, genres, data, 0, data.getSize(), tagsToRead); // create shortcuts for most common data.
      ...
      tags["genres"] = genres.map(function (genre) {
        return genre.data;
      });
      return {
        "type": "MP4",
    ...
    key: "_readAtom",
    value: function _readAtom(tags, genres, data, offset, length, tagsToRead, parentAtomFullName, indent) {
