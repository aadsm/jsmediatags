...
var StringUtils = {
  readUTF16String: function readUTF16String(bytes, bigEndian, disableBreakAtNull, maxBytes) {
    var ix = 0;
    var offset1 = 1,
        offset2 = 0;
  ...
  readUTF8String: function readUTF8String(bytes, disableBreakAtNull, maxBytes) {
    var ix = 0;
    maxBytes = Math.min(maxBytes || bytes.length, bytes.length);
  ...
  readNullTerminatedString: function readNullTerminatedString(bytes, disableBreakAtNull, maxBytes) {
    var arr = [];
