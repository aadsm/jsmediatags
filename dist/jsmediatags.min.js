...
b.getStringAt(c+4,4),g=b.getInteger24At(c+16+1,!0),g=d[g],k;if("trkn"==f)k={track:b.getByteAt(c+16+11),total:b.getByteAt(c+16+13)};else{var l=c+24,m=e-24;"covr"===f&&"uint8"===g&&(g="jpeg");switch(g){case "text":k=b.getStringWithCharsetAt(l,m,"utf-8").toString();break;case "uint8":k=b.getShortAt(l,!1);break;case "jpeg":case "png":k={format:"image/"+g,data:b.getBytesAt(l,m)}}}return{id:f,size:e,description:a[f]||"Unknown",data:k}}},{key:"getShortcuts",value:function(){return c}}],[{key:"getTagIdentifierByteRange",
...
sfID:"Country Code"},c={title:"\u00a9nam",artist:"\u00a9ART",album:"\u00a9alb",year:"\u00a9day",comment:"\u00a9cmt",track:"trkn",genre:"\u00a9gen",picture:"covr",lyrics:"\u00a9lyr"};m.exports=f},{"./MediaFileReader":10,"./MediaTagReader":11}],10:[function(f,m,l){var k=function(){function d(a,c){for(var b=0;b<c.length;b++){var e=c[b];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(a,c,b){c&&d(a.prototype,c);b&&d(a,b);return a}}(),
...
d&&this._setRequestHeader(g,"Range","bytes="+d[0]+"-"+d[1]);for(var l in c._config.additionalXhrHeaders)this._setRequestHeader(g,l,c._config.additionalXhrHeaders[l]);this._setRequestHeader(g,"If-Modified-Since","Sat, 01 Jan 1970 00:00:00 GMT");g.send(null)}},{key:"_setRequestHeader",value:function(a,d,f){0>c._config.disallowedXhrHeaders.indexOf(d.toLowerCase())&&a.setRequestHeader(d,f)}},{key:"_hasResponseHeader",value:function(a,c){var d=a.getAllResponseHeaders();if(!d)return!1;for(var d=d.split("\r\n"),
...
}}],[{key:"canReadFile",value:function(a){return"string"===typeof a&&/^[a-z]+:\/\//i.test(a)}},{key:"setConfig",value:function(a){for(var c in a)a.hasOwnProperty(c)&&(this._config[c]=a[c]);a=this._config.disallowedXhrHeaders;for(c=0;c<a.length;c++)a[c]=a[c].toLowerCase()}}]);return c}(f("./MediaFileReader"));l._config={additionalXhrHeaders:[],avoidHeadRequests:!1,disallowedXhrHeaders:{},timeoutInSec:30};m.exports=l},{"./ChunkedFileData":5,"./MediaFileReader":10,xhr2:2}],14:[function(f,m,l){function k(a,
b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}var g=function(){function a(b,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(b,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();f("./MediaFileReader");l=f("./NodeFileReader");var d=f("./XhrFileReader"),a=f("./BlobFileReader"),c=f("./ArrayFileReader");f("./MediaTagReader");var b=f("./ID3v1TagReader"),
e=f("./ID3v2TagReader");f=f("./MP4TagReader");var h=[],n=[],p=function(){function a(b){k(this,a);this._file=b}g(a,[{key:"setTagsToRead",value:function(a){this._tagsToRead=a;return this}},{key:"setFileReader",value:function(a){this._fileReader=a;return this}},{key:"setTagReader",value:function(a){this._tagReader=a;return this}},{key:"read",value:function(a){var b=new (this._getFileReader())(this._file),c=this;b.init({onSuccess:function(){c._getTagReader(b,{onSuccess:function(d){(new d(b)).setTagsToRead(c._tagsToRead).read(a)},
...
value:function(a,b){for(var c=[],d=[],e=a.getSize(),f=0;f<n.length;f++){var g=n[f].getTagIdentifierByteRange();0<=g.offset&&g.offset<e/2||0>g.offset&&g.offset<-e/2?c.push(n[f]):d.push(n[f])}var h=!1,f={onSuccess:function(){if(h){for(var c=0;c<n.length;c++){var d=n[c].getTagIdentifierByteRange(),d=a.getBytesAt(0<=d.offset?d.offset:d.offset+e,d.length);if(n[c].canReadTagFormat(d)){b.onSuccess(n[c]);return}}if(b.onError)b.onError({type:"tagFormat",info:"No suitable tag reader found"})}else h=!0},onError:b.onError};
this._loadTagIdentifierRanges(a,c,f);this._loadTagIdentifierRanges(a,d,f)}},{key:"_loadTagIdentifierRanges",value:function(a,b,c){if(0===b.length)setTimeout(c.onSuccess,1);else{for(var d=[Number.MAX_VALUE,0],e=a.getSize(),f=0;f<b.length;f++){var g=b[f].getTagIdentifierByteRange(),h=0<=g.offset?g.offset:g.offset+e,g=h+g.length-1;d[0]=Math.min(h,d[0]);d[1]=Math.max(g,d[1])}a.loadRange(d,c)}}}]);return a}(),t=function(){function a(){k(this,a)}g(a,null,[{key:"addFileReader",value:function(b){h.push(b);
return a}},{key:"addTagReader",value:function(b){n.push(b);return a}},{key:"removeTagReader",value:function(b){b=n.indexOf(b);0<=b&&n.splice(b,1);return a}},{key:"EXPERIMENTAL_avoidHeadRequests",value:function(){d.setConfig({avoidHeadRequests:!0})}},{key:"setAdditionalXhrHeaders",value:function(a){d.setConfig({additionalXhrHeaders:a})}},{key:"setDisallowedXhrHeaders",value:function(a){d.setConfig({disallowedXhrHeaders:a})}},{key:"setXhrTimeoutInSec",value:function(a){d.setConfig({timeoutInSec:a})}}]);
return a}();t.addFileReader(d).addFileReader(a).addFileReader(c).addTagReader(e).addTagReader(b).addTagReader(f);"undefined"!==typeof process&&t.addFileReader(l);m.exports={read:function(a,b){(new p(a)).read(b)},Reader:p,Config:t}},{"./ArrayFileReader":3,"./BlobFileReader":4,"./ID3v1TagReader":6,"./ID3v2TagReader":8,"./MP4TagReader":9,"./MediaFileReader":10,"./MediaTagReader":11,"./NodeFileReader":1,"./XhrFileReader":13}]},{},[14])(14)});
