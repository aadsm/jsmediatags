...
function(b){b=new Uint8Array(n.result);g._fileData.addData(c[0],b);a.onSuccess()};n.onerror=n.onabort=function(c){if(a.onError)a.onError({type:"blob",blob:n.error})};n.readAsArrayBuffer(b)}},{key:"getByteAt",value:function(c){return this._fileData.getByteAt(c)}}],[{key:"canReadFile",value:function(c){return"undefined"!==typeof Blob&&c instanceof Blob}}]);return b}(e("./MediaFileReader"));k.exports=e},{"./ChunkedFileData":4,"./FlowTypes":5,"./MediaFileReader":10}],4:[function(e,k,m){var l=function(){function e(f,
...
e,c+e+8],{onSuccess:function(){f._loadAtom(a,c+e,b,d)},onError:d.onError})}}}},{key:"_isContainerAtom",value:function(a){return 0<=["moov","udta","meta","ilst"].indexOf(a)}},{key:"_canReadAtom",value:function(a){return"----"!==a}},{key:"_parseData",value:function(a,c){var d={};this._readAtom(d,a,0,a.getSize(),c);for(var f in b)if(b.hasOwnProperty(f)){var e=d[b[f]];e&&(d[f]="track"===f?e.data.track:e.data)}return{type:"ID4",tags:d}}},{key:"_readAtom",value:function(a,c,b,d,f,e,h){h=void 0===h?"":h+
"  ";for(var q=b;q<b+d;){var l=c.getLongAt(q,!0);if(0==l)break;var k=c.getStringAt(q+4,4);if(this._isContainerAtom(k)){"meta"==k&&(q+=4);this._readAtom(a,c,q+8,l-8,f,(e?e+".":"")+k,h);break}(!f||0<=f.indexOf(k))&&"moov.udta.meta.ilst"===e&&this._canReadAtom(k)&&(a[k]=this._readMetadataAtom(c,q));q+=l}}},{key:"_readMetadataAtom",value:function(c,b){var d=c.getLongAt(b,!0),e=c.getStringAt(b+4,4),h=c.getInteger24At(b+16+1,!0),h=f[h],k;if("trkn"==e)k={track:c.getByteAt(b+16+11),total:c.getByteAt(b+16+
13)};else{var l=b+24,q=d-24;switch(h){case "text":k=c.getStringWithCharsetAt(l,q,"utf-8").toString();break;case "uint8":k=c.getShortAt(l,!1);break;case "jpeg":case "png":k={format:"image/"+h,data:c.getBytesAt(l,q)}}}return{id:e,size:d,description:a[e]||"Unknown",data:k}}}],[{key:"getTagIdentifierByteRange",value:function(){return{offset:0,length:11}}},{key:"canReadTagFormat",value:function(a){return"ftypM4A"===String.fromCharCode.apply(String,a.slice(4,11))}}]);return d}(m);var f={0:"uint8",1:"text",
...
tvnn:"TV Network",desc:"Description",ldes:"Long Description",sonm:"Sort Name",soar:"Sort Artist",soaa:"Sort Album",soco:"Sort Composer",sosn:"Sort Show",purd:"Purchase Date",pcst:"Podcast",purl:"Podcast URL",catg:"Category",hdvd:"HD Video",stik:"Media Type",rtng:"Content Rating",pgap:"Gapless Playback",apID:"Purchase Account",sfID:"Country Code"},b={title:"\u00a9nam",artist:"\u00a9ART",album:"\u00a9alb",year:"\u00a9day",comment:"\u00a9cmt",track:"trkn",genre:"\u00a9gen",picture:"covr",lyrics:"\u00a9lyr"};
k.exports=e},{"./FlowTypes":5,"./MediaFileReader":10,"./MediaTagReader":11}],10:[function(e,k,m){var l=function(){function f(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1;d.configurable=!0;"value"in d&&(d.writable=!0);Object.defineProperty(a,d.key,d)}}return function(a,b,c){b&&f(a.prototype,b);c&&f(a,c);return a}}();e("./StringUtils");e("./FlowTypes");var h=e("./StringUtils");e=function(){function f(){if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");
...
e.responseBody||e.responseText);b.onSuccess()},onError:b.onError}))}},{key:"_roundRangeToChunkMultiple",value:function(a){return[a[0],a[0]+1024*Math.ceil((a[1]-a[0]+1)/1024)-1]}},{key:"_makeXHRRequest",value:function(a,b,f){var e=this._createXHRObject(),h=function(){if(200===e.status||206===e.status)f.onSuccess(e);else if(f.onError)f.onError({type:"xhr",xhr:e});e=null};"undefined"!==typeof e.onload?(e.onload=h,e.onerror=function(){if(f.onError)f.onError({type:"xhr",xhr:e})}):e.onreadystatechange=
function(){4===e.readyState&&h()};e.open(a,this._url);e.overrideMimeType("text/plain; charset=x-user-defined");b&&e.setRequestHeader("Range","bytes="+b[0]+"-"+b[1]);e.setRequestHeader("If-Modified-Since","Sat, 01 Jan 1970 00:00:00 GMT");e.send(null)}},{key:"getByteAt",value:function(a){return this._fileData.getByteAt(a).charCodeAt(0)&255}},{key:"_createXHRObject",value:function(){if("undefined"===typeof window)return new (e("xhr2").XMLHttpRequest);if(window.XMLHttpRequest)return new window.XMLHttpRequest;
throw Error("XMLHttpRequest is not supported");}}],[{key:"canReadFile",value:function(a){return"string"===typeof a&&/^[a-z]+:\/\//i.test(a)}}]);return b}(e("./MediaFileReader"));k.exports=m},{"./ChunkedFileData":4,"./FlowTypes":5,"./MediaFileReader":10,xhr2:2}],14:[function(e,k,m){function l(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}var h=function(){function a(b,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in
...
b[f].getTagIdentifierByteRange(),h=0<=g.offset?g.offset:g.offset+e,g=h+g.length-1;d[0]=Math.min(h,d[0]);d[1]=Math.max(g,d[1])}a.loadRange(d,c)}}}]);return a}(),n=function(){function a(){l(this,a)}h(a,null,[{key:"addFileReader",value:function(a){d.push(a);return this}},{key:"addTagReader",value:function(a){g.push(a);return this}},{key:"removeTagReader",value:function(a){a=g.indexOf(a);0<=a&&g.splice(a,1);return this}}]);return a}();n.addFileReader(f).addFileReader(a).addTagReader(c).addTagReader(b).addTagReader(e);
"undefined"!==typeof process&&n.addFileReader(m);k.exports={read:function(a,b){(new p(a)).read(b)},Reader:p,Config:n}},{"./BlobFileReader":3,"./FlowTypes":5,"./ID3v1TagReader":6,"./ID3v2TagReader":8,"./MP4TagReader":9,"./MediaFileReader":10,"./MediaTagReader":11,"./NodeFileReader":1,"./XhrFileReader":13}]},{},[14])(14)});
